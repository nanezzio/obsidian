...
- подсветки уровней логов: INFO (зелёный), WARNING (жёлтый), ERROR (красный);
- подсветки важных сообщений в CLI‑утилитах;
- более удобной отладки (ошибки и предупреждения визуально видны в консоли).