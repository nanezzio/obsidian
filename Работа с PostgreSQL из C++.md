...
Другой способ - это подготовить шаблон запроса SQL, чтобы потом просто подставить в него нужные данные. Такие шаблоны называются - Prepared statement
...
В дальнейшем можно вызывать prepared statement по имени сколько угодно раз, подставляя необходимые параметры
